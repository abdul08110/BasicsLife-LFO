...
import com.hasbro.basicslife_lfo.databinding.StepnineBinding;

import java.util.ArrayList;
import java.util.HashMap;

public class stepNine extends AppCompatActivity {

    private StepnineBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = StepnineBinding.inflate(getLayoutInflater());
    ...
    private void setupButtonListeners() {
        ...
        binding.btnNextStep.setOnClickListener(v -> goToStepTen());
    }

    private void goToStepTen() {
        Intent intent = new Intent(stepNine.this, stepTen.class);
