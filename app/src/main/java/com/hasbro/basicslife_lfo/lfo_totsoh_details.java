...
import com.hasbro.basicslife_lfo.databinding.LfoTotsohDetailsBinding;
...
public class lfo_totsoh_details extends AppCompatActivity {
    private LfoTotsohDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = LfoTotsohDetailsBinding.inflate(getLayoutInflater());
...
//        String type = design.equals("BTR") ? "fit_name" : "design";
    ...
    private void fetchData(String endpoint, String product, String type, String strid, Response.Listener<JSONObject> responseListener) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                error ->{
                    ...
                    Toast.makeText(lfo_totsoh_details.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                });
    ...
    private void fetchSOHData(String product, String type, String strid) {
        fetchData("getTOTSOHDetail", product, type, strid, response -> {
            SOHObj = response;
    ...
    private void setHeaderText() {
        binding.salesHeader.setText("TOTAL STOCK ON HAND-DETAILS");
    }
