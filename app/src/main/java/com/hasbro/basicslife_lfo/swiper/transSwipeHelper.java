package com.hasbro.basicslife_lfo.swiper;
...
public abstract class transSwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public transSwipeHelper(Context context, RecyclerView recyclerView) {
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX < 0) {
                ...
                if (!buttonsBuffer.containsKey(pos)){
                    ...
                    buffer = (ArrayList<UnderlayButton>) buttonsBuffer.get(pos);
                }
